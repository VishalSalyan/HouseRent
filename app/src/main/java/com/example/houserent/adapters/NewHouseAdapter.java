...
public class NewHouseAdapter extends RecyclerView.Adapter<NewHouseAdapter.ViewHolder> {

    private ArrayList<HouseData> carList;
    private Context context;

    // data is passed into the constructor
    public NewHouseAdapter(Context context, ArrayList<HouseData> carList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.container.setOnClickListener(v -> {
            ...
            intent.putExtra("carId", houseData.getId());
            intent.putExtra("mode", Constants.FLATS_COLLECTION);
